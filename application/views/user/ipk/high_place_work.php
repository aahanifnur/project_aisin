        ...
        <div class="col-xl-6 col-lg-7 mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a class="m-0 float-left btn btn-danger btn-sm" href="<?= base_url('user/edit_adm'); ?>"> Edit Data <i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    foreach ($result1 as $data) :
                                    ?>
                                        <?php if ($data['apv_kontraktor_jsa'] == 1) {
                                            echo '<span class="badge badge-success">Approved</span>';
                                        } else {
                                            echo '<span class="badge badge-warning">Pending</span>';
                                        } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    foreach ($result1 as $data) :
                                    ?>
                                        <?php if ($data['apv_kontraktor_chklist'] == 1) {
                                            echo '<span class="badge badge-success">Approved</span>';
                                        } else {
                                            echo '<span class="badge badge-warning">Pending</span>';
                                        } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    foreach ($result1 as $data) :
                                    ?>
                                        <?php if ($data['apv_kontraktor_lisensi'] == 1) {
                                            echo '<span class="badge badge-success">Approved</span>';
                                        } else {
                                            echo '<span class="badge badge-warning">Pending</span>';
                                        } ?>
                                ...
                                <?php foreach ($result1 as $data) : ?>
                                    <td><a href="<?= base_url('user/upload_file/' . $data['id']); ?>" class="btn btn-sm btn-primary">Detail</a></td>
                                <?php endforeach; ?>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    foreach ($result1 as $data) :
                                    ?>
                                        <?php if ($data['apv_kontraktor_cttn'] == 1) {
                                            echo '<span class="badge badge-success">Approved</span>';
                                        } else {
                                            echo '<span class="badge badge-warning">Pending</span>';
                                        } ?>
                                ...
                                <?php foreach ($result1 as $data) : ?>
                                    <td><a href="<?= base_url('user/catatan_pekerjaan_khusus/' . $data['id']); ?>" class="btn btn-sm btn-primary">Detail</a></td>
                                <?php endforeach; ?>
                            </tr>
                        </tbody>
                    </table>
