							...
							<form action="" method="post" class="f1">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<input type="" name="" placeholder="No Registrasi" class="form-control" disabled>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="" name="nama_akhir" placeholder="Nama Kontraktor" class="form-control">
									</div>
									<div class="form-group">
								...
								<fieldset>
									<div>
										...
										<button type="button" name="add" id="add" class="btn btn-primary remove_item_btn">
											Add More
										</button>
									</div>
									<br>
