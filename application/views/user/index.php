  ...
  <div class="">
    <div class="card">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">IPK</h6>
        <!-- <a class="m-0 float-right btn btn-danger btn-sm" href="<?php
                                                                    // base_url('ExportExcel/export'); 
                                                                    ?>">Export <i class="fas fa-chevron-right"></i></a> -->
      </div>
            ...
            ?>
              <tr>
                ...
                <td>
                  <?php
                  // printf($result);
                  // foreach ($result as $stt) : 
                  ?>
                  <?php if ($data['apv_administrasi'] == 1) {
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="dropdown dropright">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="<?= base_url('user/hpw_c'); ?>">High Place Work</a>
        <a class="dropdown-item" href="<?= base_url('user/hw_c'); ?>">Hot Work</a>
        <a class="dropdown-item" href="<?= base_url('user/cs_c'); ?>">Confined Space</a>
        <a class="dropdown-item" href="<?= base_url('user/g_c'); ?>">General</a>
      </div>
    </div>
  </div>
  <!--Row-->