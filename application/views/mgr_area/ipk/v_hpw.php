                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-center h5 mb-0 font-weight-bold text-gray-800"><span class="badge badge">None</span></div>
                        ...
                        <div class="col-xl-6 col-lg-7 mb-4">
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a class="m-0 float-left btn btn-danger btn-sm" href="<?= base_url('user/isi_adm'); ?>">Isi Form <i class="fas fa-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('user/pernyataan'); ?>" class="btn btn-sm btn-primary disabled">Detail</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('user/jsa'); ?>" class="btn btn-sm btn-primary disabled">Detail</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('user/check_list'); ?>" class="btn btn-sm btn-primary disabled">Detail</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('user/upload_file'); ?>" class="btn btn-sm btn-primary disabled">Detail</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('user/catatan_pekerjaan_khusus'); ?>" class="btn btn-sm btn-primary disabled">Detail</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
