            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('admin'); ?>">Izin Pekerjaan Khusus</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('admin/hpw_c'); ?>">High Place Work</a>
                        <a class="collapse-item" href="<?= base_url('admin/cs_c'); ?>">Confined Space</a>
                        <a class="collapse-item" href="<?= base_url('admin/hw_c'); ?>">Hot Work</a>
                        <a class="collapse-item" href="<?= base_url('admin/g_c'); ?>">General</a>
                    </div>
                </div>
            </li>
